...
time_unit_from_sec <- 1/3600 #Use minute instead of seconds

K_M_siRNA <- 0.1 * mole_unit_from_nano_mole
k_on_siRNA <- 3.6e7 / (mole_unit_from_mole * time_unit)
k_off_siRNA <- 7.7e-4 / time_unit
k_cat_siRNA <- 8.1e-4 / time_unit

k_on_miRNA <- 0.2e8 / (mole_unit_from_mole * time_unit)
k_off_miRNA <- 0.051e-2 / time_unit
