...
- do we measure uncleave target RNA or free target mRNA? (matters only in somatice cells)
...
We want to get complete degradation with siRNA in oocyte in a reasonable time. Assuming siRNA with the same concentration as let7
...
plot_ode_result(out_siRNA,paste0("Hypothethical siRNA, oocyte"))
